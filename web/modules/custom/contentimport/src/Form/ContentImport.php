...
class ContentImport extends ConfigFormBase { 
  ...
  */
      ...
      if (($handle = fopen($location, "r")) !== FALSE) {
          ...
          while (($data = fgetcsv($handle)) !== FALSE) { 
            ...
            if ($index < 2) {
              ...
              // If No title is set, Select Index Number of the Column to act as Title below
   ...
   */
                ...
                // Over-riding requirement for having to provide langcode on everything.
                default:
                  $nodeArray[$fieldNames[$f]] = 'en';
                  break;
              }             
